...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    """
    Returns a leaderboard of the meals sorted by a specified parameter.

    Args:
        sort_by (str): The column that the leaderboard should be sorted on.

    Returns:
        dict[str, Any]: The leaderboard of meals.

    Raises:
        ValueError: If the sort_by parameter is not win_pct or wins.
        sqlite3.Error: If any database error occurs.
    """
    query = """
...
def get_meal_by_id(meal_id: int) -> Meal:
    ...
    Raises:
        ValueError: If the meal has been marked for deleted or not found.
        sqlite3.Error: If any database error occurs.    
    """
    try:
        with get_db_connection() as conn:
...
def get_meal_by_name(meal_name: str) -> Meal:
    """
    Retrieves a meal from the meals table with a given meal_name.
    ...
    Raises:
        ValueError: If the meal has been marked for deletion or a meal is not found with said name.
        sqlite3.Error: If any database error occurs.
    """
    try:
        with get_db_connection() as conn:
...
def update_meal_stats(meal_id: int, result: str) -> None:
    """
    Updates a meal's stats based on the result of a battle.

    Args: 
        meal_id (int): The ID of the meal to be updated.
        result (str): The result of the meal's battle.
        
    Raises:
        ValueError: If the meal has been marked for deleted or could not be found. Also if the result is not valid.
        sqlite3.Error: If any database error occurs.
    """
    try:
        with get_db_connection() as conn:
